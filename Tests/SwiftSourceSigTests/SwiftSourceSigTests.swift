...
@Test func `one unsigned generated section`() throws {
    ...
    guard case .unsignedGenerated(let code, _, _) = parsed.sections[0] else {
        Issue.record()
        return
    }
...
@Test func `signing code`() throws {
    ...
    guard case .generated(let codeHash, let code, _, _, _) = signed.sections[0] else {
        Issue.record()
        return
    }
...
@Test func `one signed generated section`() throws {
    let parsed = try ParsedCode(code: """
        ...
        """)
    try #require(parsed.sections.count == 1)
    guard case .generated(let codeHash, let code, _, _, _) = parsed.sections[0] else {
        Issue.record()
        return
    }
...
@Test func `one manual section`() throws {
    let parsed = try ParsedCode(code: """
        ...
        """)
    try #require(parsed.sections.count == 1)
    guard case .manual(let manualSectionName, let code, _, _) = parsed.sections[0] else {
        Issue.record()
        return
    }
    #expect(manualSectionName == "my-manual")
...
@Test func `multiple sections with indentation`() throws {
    let parsed = try ParsedCode(code: """
        // This file is automatically generated, but has editable manual sections.
        // Only edit the code between the manual sections.
        // Do NOT edit code outside of the manual sections.
        ...
        // @generated-section-start fake-hash0
        func indented() {
            // @generated-section-end fake-hash0
            // @manual-section-start my-manual1
            myManual1()
            // @manual-section-end my-manual1
            
            // @generated-section-start fake-hash1
            myCode1()
            // @generated-section-end fake-hash1
            
            // @manual-section-start my-manual2
            myManual2()
            // @manual-section-end my-manual2
        ...
        // @generated-section-end fake-hash2
        """)
    #expect(parsed.sections.count == 5)
    let rendered = try parsed.toString()
    #expect(rendered == """
        // This file is automatically generated, but has editable manual sections.
        // Only edit the code between the manual sections.
...
@Test func `multiple sections with indentation 2`() throws {
    let code = """
        // This file is automatically generated, but has editable manual sections.
        // Only edit the code between the manual sections.
        // Do NOT edit code outside of the manual sections.
        ...
        func indented() {
            // @manual-section-placeholder my-manual1
            myCode1()
            // @manual-section-placeholder my-manual2   
            myCode2()
        }
        """
    let previousState = """
    ...
    #expect(result == """
        ...
        // @generated-section-start ee8d0aa0f336ab0f
        func indented() {
        // @generated-section-end ee8d0aa0f336ab0f

            // @manual-section-start my-manual1
            myManual1()
            // @manual-section-end my-manual1

            // @generated-section-start d00d44c90a435cb9
            myCode1()
            // @generated-section-end d00d44c90a435cb9

            // @manual-section-start my-manual2
            myManual2()
            // @manual-section-end my-manual2

            // @generated-section-start b287b5638d8d637d
            myCode2()
        }
        // @generated-section-end b287b5638d8d637d
